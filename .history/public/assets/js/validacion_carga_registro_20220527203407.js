        ...
        if (data[0].length > 0) {
            ...
            for (i=0; i<data[0].length; i++){
                ...
                */
                ...
                cadena+="<input type='text' class='form-control' id='ind_0"+data[0][i]['indicador_id']+"' name='ind_0"+data[0][i]['indicador_id']+"' value='"+data[0][i]['valor']+"-"+data[0][i]['registro_id']+"' size='10'>";
                cadena+="</div></div>";
            }
