function filtrar(){
    ...
    $.ajax({
        ...
        //console.log(data);
        if (data[0].length > 0) {
            var cadena="<div class='row'><table class='table table-striped table-bordered'><thead><tr><th>Nombre</th><th>Valor</th></tr></thead><tbody>";
            for (i=0; i<data[0].length; i++){
                ...
                */
                ...
                cadena+="<input type='text' class='form-control' id='ind_0"+i+"' name='ind_0"+i+"' value='"+data[0][i]['valor']+"' size='10'></td></tr>";
            }
