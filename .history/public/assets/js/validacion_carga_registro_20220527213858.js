        ...
        if (data[0].length > 0) {
            ...
            for (i=0; i<data[0].length; i++){
                ...
                */
                ...
                cadena+="<input type='hidden' class='form-control' id='indice_0"+data[0][i]['indicador_id']+"' name='indice_0"+data[0][i]['indicador_id']+"' value='"+data[0][i]['indicador_id']+"-"+data[0][i]['registro_id']+"'>";
                cadena+="<input type='text' class='form-control' id='ind_0"+data[0][i]['indicador_id']+"' name='ind_0"+data[0][i]['indicador_id']+"' value='"+data[0][i]['valor']+"' size='10'>";
                cadena+="</div></div>";
            }
            cadena+="</div><div class='row'>&nbsp;</div>";
